...
class ChatToNPC(CommandBase):
    ...
    async def execute(self, params):
        ...
        self.app.send(player_id, {"code": 200, "uri": "chatWith", "uid": player_id, "data": {"sourceID": player_id, "targetID": NPC_id, "content": content}})
        ...
        info = {"source": "chatted", "data": {
            ...
            "topic": "",
            "chat_cache": [{"speaker": player_model.name, "content": content}],
        ...
        self.app.send(player_id, {"code": 200, "uri": "chatWith", "uid": NPC_id, "data": {"sourceID": NPC_id, "targetID": player_id, "content": response}})
