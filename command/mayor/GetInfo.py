...
class GetInfo(CommandBase):
    ...
    def execute(self, params):
        ...
        ret_data = {
            ...
            "buildings": [{"name": building["n"], "x": building["x"], "y": building["y"], "income": building["eI"], "beds": building["lC"], "livings": building["lL"], "id": building["id"]} for building in self.get_single_model("Buildings").buildings],
            "npcs": list(),
